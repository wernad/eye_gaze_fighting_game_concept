...
/// <summary>
/// Main class of AI. Contains all AI's logic.
/// </summary>
...
{   
    ...
    ///Decision made is based partly on random numbers, partly on enemy state (crouching, blocking).
    /// </summary>
    void Offense() {
    ...
    /// <summary>
    /// Set if last attack hit or not.
    /// </summary>
    /// <param name="hit">Bool value if last attack hit.</param>
    public void SetLastAttackHit(bool value) {
        lastAttackHit = value;
    }

    /// <summary>
    /// Set if last attack got blocked or not.
    /// </summary>
    /// <param name="hit">Bool value if last attack got blocked.</param>
